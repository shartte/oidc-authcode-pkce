/**
 * Models the standard claims that can be returned, which are defined in 5.1. of the OIDC Core specification,
 * but also includes any additional claims the ID token may have.
 */
export type OIDCStandardClaims = {
  /**
   ...
   * +1 (425) 555-1212 or +56 (2) 687 2400. If the phone number contains an extension, it is RECOMMENDED that
   * the extension be represented using the RFC 3966 [RFC3966] extension syntax, for example, +1 (604)
   * 555-1234;ext=5678.
   */
  phone_number?: string;
   ...
   * are operating. When true, the phone_number Claim MUST be in E.164 format and any extensions MUST be
...
/**
 * A claim about the user's address, as specified in OIDC Core 5.1.1..
 */
type OIDCAddressClaims = {
  /**
